...
#
# Run this once after inviting @viber:samprim.net to the control room,
...
#
# Examples:
#   bash accept-invite.sh '!abc123:samprim.net' 'syt_dmliZXI_xxx...'
#   bash accept-invite.sh '#viber-control:samprim.net' 'syt_dmliZXI_xxx...'

set -e

ROOM="${1:?usage: accept-invite.sh <room_id_or_alias> <access_token>}"
TOKEN="${2:?usage: accept-invite.sh <room_id_or_alias> <access_token>}"
HOMESERVER="${HOMESERVER:-https://matrix.samprim.net}"
